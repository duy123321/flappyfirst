...
class FlappyBirdAIQ:
    ...
    def play_step(self, action):
        ...
        while lock > 0:
            ...
            if self.kirbRect.colliderect(self.ground_rect) or self.kirbRect.colliderect(self.pipeBotRet) or self.kirbRect.colliderect(self.pipeTopRet):
                game_over = True
                reward = -1000
                return reward, game_over, self.score, True
    ...
    def _update_ui(self):
        ...
        score_surf = test_font.render(f'Score: {self.score}',False,(64,64,64))
